...
import { useArtifact } from "loveui-ai-tools/client";
    ...
    <div className="h-full overflow-auto p-6 space-y-6">
      ...
      <Card className="border-0 shadow-none">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm">Pipeline Momentum</CardTitle>
        </CardHeader>
        <CardContent>
        ...
        <Card className="shadow-none">
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-xs text-muted-foreground">Win/Loss Shift</p>
                <p className="text-lg font-semibold">
      ...
      <Card className="border-0 shadow-none">
        <CardHeader className="pb-3">
          <CardTitle className="text-sm">Work Type Mix</CardTitle>
        </CardHeader>
